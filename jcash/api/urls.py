...
urlpatterns = [
    ...
    url(r'^customer/personal/confirmations/', views.ConfirmationsView.as_view(customer_type='personal')),
    ...
    url(r'^customer/personal/video-verification/$', views.VideoVerificationView.as_view(customer_type='personal')),
    url(r'^customer/corporate/confirmations/', views.ConfirmationsView.as_view(customer_type='corporate')),
    ...
    url(r'^customer/corporate/video-verification/$', views.VideoVerificationView.as_view(customer_type='corporate')),
